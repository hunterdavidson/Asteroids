...
#include "Asteroids/MyPawn.h"
PRAGMA_DISABLE_DEPRECATION_WARNINGS
void EmptyLinkFunctionForGeneratedCodeMyPawn() {}
// Cross Module References
	ASTEROIDS_API UClass* Z_Construct_UClass_AMyPawn();
	ASTEROIDS_API UClass* Z_Construct_UClass_AMyPawn_NoRegister();
...
// End Cross Module References
	...
	template<> ASTEROIDS_API UClass* StaticClass<AMyPawn>()
	{
		return AMyPawn::StaticClass();
	}
	DEFINE_VTABLE_PTR_HELPER_CTOR(AMyPawn);
	AMyPawn::~AMyPawn() {}
	struct Z_CompiledInDeferFile_FID_Users_Hunter_source_repos_hunterdavidson_Asteroids_Source_Asteroids_MyPawn_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_Hunter_source_repos_hunterdavidson_Asteroids_Source_Asteroids_MyPawn_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_AMyPawn, AMyPawn::StaticClass, TEXT("AMyPawn"), &Z_Registration_Info_UClass_AMyPawn, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(AMyPawn), 1937572576U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_Hunter_source_repos_hunterdavidson_Asteroids_Source_Asteroids_MyPawn_h_841042736(TEXT("/Script/Asteroids"),
		Z_CompiledInDeferFile_FID_Users_Hunter_source_repos_hunterdavidson_Asteroids_Source_Asteroids_MyPawn_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Users_Hunter_source_repos_hunterdavidson_Asteroids_Source_Asteroids_MyPawn_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
